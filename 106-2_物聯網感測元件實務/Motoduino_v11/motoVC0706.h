...
class motoVC0706 {
 public:
#if ARDUINO >= 100
  motoVC0706(SoftwareSerial *ser); // Constructor when using SoftwareSerial
#else
  motoVC0706(NewSoftSerial  *ser); // Constructor when using NewSoftSerial
#endif
  motoVC0706(HardwareSerial *ser); // Constructor when using HardwareSerial
