 ...
 * THE SOFTWARE.
 */
#ifndef __MOTOESP8266_H__
#define __MOTOESP8266_H__
...
class ESP8266 {
 ...
 private:
    ...
    bool findString(String list, String target);
    String getSubString(String list, String nextString);
    ...
    String sATCIPSTA_CUR(uint32_t timeout);    
    /*
     * +IPD,len:data
     * +IPD,id,len:data
     */
